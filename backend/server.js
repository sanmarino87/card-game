...
async function seedQuestions() {
  ...
  const easyQuestions = [
    ...
    "Heb je ooit gespieed op iemand?",
    "Wat voor kleur ondergoed draag je nu?",
    // ... (totaal 100, ik laat alleen eerste 10 zien voor overzicht)
  ];
  ...
  const mediumQuestions = [
    ...
    "Fluister je meest pikante gedachte in iemands oor",
  ...
  const hardQuestions = [
    ...
    "Streel je eigen lichaam sensueel terwijl je iemand aankijkt",
