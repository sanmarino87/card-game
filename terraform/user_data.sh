...
-- ============================================
-- EXTRA 300 Erotische Vragen voor Card Game
-- Easy: 100 vragen (1 punt)
-- Medium: 100 vragen (3 punten)  
-- Hard: 100 vragen (5 punten)
-- ============================================
...
(1, 'Heb je ooit stiekem naar iemand gekeken terwijl ze zich omkleedden?', 1),
(1, 'Wat is je favoriete lichaamsdeel van jezelf?', 1),
(1, 'Ben je ooit gepakt tijdens het daten?', 1),
(1, 'Hoe oud was je bij je eerste tongzoen?', 1),
(1, 'Wat vind je het meest opwindende aan iemand?', 1),
(1, 'Heb je ooit een onenight stand gehad?', 1),
(1, 'Wat is je favoriete positie om te liggen op de bank?', 1),
(1, 'Ben je ooit wakker geworden naast iemand die je niet kende?', 1),
(1, 'Heb je ooit gefantaseerd over een leraar of baas?', 1),
(1, 'Wat is de gekste plek waar je ooit hebt gezoend?', 1),
(1, 'Heb je ooit iemand naakt gezien per ongeluk?', 1),
(1, 'Wat draag je het liefst in bed?', 1),
(1, 'Ben je ooit betrapt tijdens het masturberen?', 1),
(1, 'Heb je ooit een erotische film gekeken met anderen?', 1),
(1, 'Wat is het meest sensuele dat iemand tegen je heeft gezegd?', 1),
(1, 'Heb je ooit verliefd gemaakt op iemands geur?', 1),
(1, 'Wat is je favoriete deel van het voorspel?', 1),
(1, 'Ben je ooit in een jacuzzi of sauna met iemand geweest?', 1),
(1, 'Heb je ooit met een ex terug naar bed geweest?', 1),
(1, 'Wat is het langste dat je ooit hebt gevreeën?', 1),
(1, 'Heb je ooit een massage gegeven die sensueel werd?', 1),
(1, 'Wat vind je het aantrekkelijkst: een gespierd of slank lichaam?', 1),
(1, 'Ben je ooit in een auto intiem geweest?', 1),
(1, 'Heb je ooit een sexspeeltje gebruikt?', 1),
(1, 'Wat is je grootste seksuele angst?', 1),
(1, 'Heb je ooit naakt gezwommen met anderen?', 1),
(1, 'Wat is het eerste wat je aantrekkelijk vindt aan iemands lichaam?', 1),
(1, 'Ben je meer visueel of tactiel aangelegd?', 1),
(1, 'Heb je ooit sexting gedaan?', 1),
(1, 'Wat is je favoriete plek op iemands lichaam om te kussen?', 1),
(1, 'Ben je ooit verliefd geworden tijdens een onenightstand?', 1),
(1, 'Heb je ooit een vreemdganger gekust?', 1),
(1, 'Wat is je meest sensuele herinnering?', 1),
(1, 'Ben je ooit opgewonden geraakt op een vreemde plek?', 1),
(1, 'Heb je ooit een trio overwogen?', 1),
(1, 'Wat is je grootste turn-off in bed?', 1),
(1, 'Ben je ooit met iemand naar bed geweest op de eerste date?', 1),
(1, 'Heb je ooit rollenspel gedaan?', 1),
(1, 'Wat is de raarste plek waar je opgewonden bent geraakt?', 1),
(1, 'Ben je ooit afgewezen na een avance?', 1),
(1, 'Heb je ooit een naaktfoto gestuurd?', 1),
(1, 'Wat zou je graag eens willen proberen in bed?', 1),
(1, 'Ben je ooit betrapt tijdens seks?', 1),
(1, 'Heb je ooit je partner laten wachten met opzet?', 1),
(1, 'Wat is je favoriete tijd van de dag voor intimiteit?', 1),
(1, 'Ben je dominant of onderdanig in bed?', 1),
(1, 'Heb je ooit een crush gehad op een goede vriend?', 1),
(1, 'Wat is het langste dat je hebt moeten wachten op seks?', 1),
(1, 'Ben je ooit in een bar of club intiem geweest?', 1),
(1, 'Heb je ooit iemand versiert met een cheesy pick-up line?', 1),
(1, 'Wat is je favoriete compliment over je uiterlijk?', 1),
(1, 'Ben je ooit in slaap gevallen tijdens seks?', 1),
(1, 'Heb je ooit iemands naam verkeerd gezegd in bed?', 1),
(1, 'Wat zou je doen als je crush je nu zou kussen?', 1),
(1, 'Ben je ooit spijt gehad van iemand waarmee je naar bed ging?', 1),
(1, 'Heb je ooit een geheim affaire gehad?', 1),
(1, 'Wat is je favoriete ondergoed om te dragen?', 1),
(1, 'Ben je ooit verleid door iemands stem?', 1),
(1, 'Heb je ooit een erotische massage gekregen?', 1),
(1, 'Wat zou je ideale romantische avond zijn?', 1),
(1, 'Ben je ooit op een vreemde manier opgewonden geraakt?', 1),
(1, 'Heb je ooit gefantaseerd tijdens seks met iemand anders?', 1),
(1, 'Wat is het meest avontuurlijke dat je ooit seksueel hebt gedaan?', 1),
(1, 'Ben je ooit uitgelachen in bed?', 1),
(1, 'Heb je ooit seks gehad in de openlucht?', 1),
(1, 'Wat is je favoriete lichaamsgeur?', 1),
(1, 'Ben je ooit door een vreemde aangeraakt?', 1),
(1, 'Heb je ooit iemand afgezworen na een slechte ervaring?', 1),
(1, 'Wat zou je doen voor een perfecte kus?', 1),
(1, 'Ben je ooit jaloers geweest op iemands sexleven?', 1),
(1, 'Heb je ooit vrienden met voordelen gehad?', 1),
(1, 'Wat is de vreemdste plek waar je bent opgepikt?', 1),
(1, 'Ben je ooit middenin gestopt tijdens seks?', 1),
(1, 'Heb je ooit iemand geneukt die je helemaal niet leuk vond?', 1),
(1, 'Wat is je grootste seksuele geheim?', 1),
(1, 'Ben je ooit high of dronken naar bed geweest met iemand?', 1),
(1, 'Heb je ooit meerdere partners in één week gehad?', 1),
(1, 'Wat vind je het meest intieme: zoenen of seks?', 1),
(1, 'Ben je ooit bang geweest tijdens een seksuele ervaring?', 1),
(1, 'Heb je ooit een vibrator gebruikt?', 1),
(1, 'Wat is het meest ongemakkelijke dat je ooit in bed hebt meegemaakt?', 1),
(1, 'Ben je ooit met iemand naar bed geweest om iemand anders te vergeten?', 1),
(1, 'Heb je ooit porno gekeken samen met iemand?', 1),
(1, 'Wat is de langste tijd dat je zonder seks hebt gezeten?', 1),
(1, 'Ben je ooit opgewonden geraakt door een massage?', 1),
(1, 'Heb je ooit tijdens het werk iets seksueels gedaan?', 1),
(1, 'Wat is het beste orgasme dat je ooit hebt gehad?', 1),
(1, 'Ben je ooit verliefd geworden op iemands handen?', 1),
(1, 'Heb je ooit stiekem iemands lichaam bewonderd?', 1),
(1, 'Wat zou je graag eens willen horen in bed?', 1),
(1, 'Ben je ooit midden in de nacht wakker gemaakt voor seks?', 1),
(1, 'Heb je ooit seks gehad met het licht aan?', 1),
(1, 'Wat is de meest verleidelijke outfit die je ooit hebt gedragen?', 1),
(1, 'Ben je ooit intiem geweest in een hotel?', 1),
(1, 'Heb je ooit iemands nek gekust als verleiding?', 1),
(1, 'Wat is het beste compliment dat je ooit in bed hebt gekregen?', 1),
(2, 'Laat iemand je pols kussen', 3),
(2, 'Fluister een vuile gedachte in iemands oor', 3),
(2, 'Dans sensueel tegen iemand aan', 3),
(2, 'Trek langzaam je trui of vest uit', 3),
(2, 'Bijt op je onderlip terwijl je iemand aankijkt', 3),
(2, 'Aai iemands been langzaam', 3),
(2, 'Ga schrijlings op iemands schoot zitten', 3),
(2, 'Laat iemand aan je haar ruiken', 3),
(2, 'Lik over je lippen op een verleidelijke manier', 3),
(2, 'Kijk iemand diep in de ogen voor 30 seconden', 3),
(2, 'Streel iemands gezicht zachtjes', 3),
(2, 'Blaas zachtjes in iemands oor', 3),
(2, 'Dans langzaam met iemand tegen je aan', 3),
(2, 'Laat iemand je hand kussen', 3),
(2, 'Fluister wat je wilt doen in iemands oor', 3),
(2, 'Trek je schoenen en sokken sensueel uit', 3),
(2, 'Masseer iemands schouders terwijl je tegen ze aan staat', 3),
(2, 'Laat iemand aan je parfum ruiken bij je nek', 3),
(2, 'Imiteer een orgasme geluid', 3),
(2, 'Ga op de schoot van iemand zitten en kijk ze aan', 3),
(2, 'Laat iemand je vingers likken', 3),
(2, 'Doe alsof je iemand verleidt met je ogen', 3),
(2, 'Trek je riem langzaam uit', 3),
(2, 'Laat iemand je voeten masseren', 3),
(2, 'Fluister je wildste fantasie in iemands oor', 3),
(2, 'Aai over iemands haar terwijl je ze aankijkt', 3),
(2, 'Ga achter iemand staan en adem in hun nek', 3),
(2, 'Laat iemand je lippen aanraken', 3),
(2, 'Dans als een stripper voor 30 seconden', 3),
(2, 'Ga liggen en laat iemand over je heen leunen', 3),
(2, 'Lik een ijsje of lolly op een suggestieve manier', 3),
(2, 'Laat iemand je taille vasthouden', 3),
(2, 'Spreek drie vuile zinnen uit', 3),
(2, 'Doe je haar los en schud het sensueel', 3),
(2, 'Laat iemand je schouder kussen', 3),
(2, 'Ga naast iemand liggen en fluister iets', 3),
(2, 'Trek je shirt een stukje omhoog', 3),
(2, 'Laat iemand je wang strelen', 3),
(2, 'Dans tegen een muur met iemand tegen je aan', 3),
(2, 'Laat iemand achter je gaan staan met hun handen op je heupen', 3),
(2, 'Bijt zachtjes op iemands vinger', 3),
(2, 'Ga op handen en knieën zitten en dans', 3),
(2, 'Laat iemand je nek masseren', 3),
(2, 'Laat iemand aan je oor fluisteren', 3),
(2, 'Trek je broek iets naar beneden zodat je heupen zichtbaar zijn', 3),
(2, 'Ga op iemands schoot zitten en dans langzaam', 3),
(2, 'Laat iemand je duim zuigen voor 5 seconden', 3),
(2, 'Doe een body roll terwijl iemand kijkt', 3),
(2, 'Laat iemand je polsen vasthouden', 3),
(2, 'Lik langs iemands vinger', 3),
(2, 'Dans met je handen boven je hoofd', 3),
(2, 'Laat iemand je onderrug aanraken', 3),
(2, 'Ga liggen en laat iemand over je buik strelen', 3),
(2, 'Blaas zachtjes op iemands gezicht', 3),
(2, 'Laat iemand je oorlel aanraken', 3),
(2, 'Trek je jas of trui sensueel uit', 3),
(2, 'Ga op je knieën zitten voor iemand', 3),
(2, 'Laat iemand je heupen vasthouden terwijl je danst', 3),
(2, 'Bijt op je vinger terwijl je iemand aankijkt', 3),
(2, 'Laat iemand je navel zien', 3),
(2, 'Ga achter iemand staan en leg je armen om ze heen', 3),
(2, 'Laat iemand je been strelen', 3),
(2, 'Dans met je ogen dicht', 3),
(2, 'Laat iemand je onderlip aanraken', 3),
(2, 'Trek je broeksband iets naar beneden', 3),
(2, 'Ga op iemands schoot zitten en fluister iets vies', 3),
(2, 'Laat iemand je rug masseren terwijl je kreunt', 3),
(2, 'Lik je lippen terwijl je iemand aankijkt', 3),
(2, 'Laat iemand je schouderbladen kussen', 3),
(2, 'Dans sensueel terwijl iemand je handen vasthoudt', 3),
(2, 'Laat iemand je billen aanraken door je kleren heen', 3),
(2, 'Ga voor iemand staan en buig voorover', 3),
(2, 'Laat iemand je dijbeen strelen', 3),
(2, 'Trek je shirt omhoog en laat je buik zien', 3),
(2, 'Ga op je rug liggen en laat iemand over je heen leunen', 3),
(2, 'Laat iemand aan je lip likken', 3),
(2, 'Dans op iemands schoot', 3),
(2, 'Laat iemand je heup kussen', 3),
(2, 'Ga op je buik liggen en laat iemand je rug masseren', 3),
(2, 'Laat iemand je tailleband aanraken', 3),
(2, 'Bijt zachtjes in iemands nek', 3),
(2, 'Dans met je handen op iemands schouders', 3),
(2, 'Laat iemand je sleutelbeen kussen', 3),
(2, 'Ga voor iemand op je knieën zitten', 3),
(2, 'Laat iemand je pols likken', 3),
(2, 'Trek je haar in een staart en laat het dan los', 3),
(2, 'Laat iemand je benen uit elkaar duwen', 3),
(2, 'Ga met je rug tegen iemand aan staan', 3),
(2, 'Laat iemand je middelvinger zuigen', 3),
(2, 'Dans als een pooledancer', 3),
(2, 'Laat iemand je nek van achteren kussen', 3),
(2, 'Ga schrijlings zitten en beweeg je heupen', 3),
(2, 'Laat iemand je hand op hun dijbeen leggen', 3),
(2, 'Bijt op je lippen terwijl je kreunt', 3),
(2, 'Laat iemand je tong zien', 3),
(3, 'Geef iemand een kus op de mond voor 15 seconden', 5),
(3, 'Trek je broek uit en blijf in je ondergoed', 5),
(3, 'Laat iemand je borsten aanraken door je kleren heen', 5),
(3, 'Geef iemand een tongzoen voor 20 seconden', 5),
(3, 'Trek je shirt helemaal uit', 5),
(3, 'Ga op iemands schoot zitten en maak draaiende bewegingen', 5),
(3, 'Laat iemand je kruis aanraken', 5),
(3, 'Geef iemand een lapdance voor 1 minuut', 5),
(3, 'Laat iemand je billen knijpen', 5),
(3, 'Zoen iemand overal behalve op de mond', 5),
(3, 'Trek je bh uit onder je kleding', 5),
(3, 'Laat iemand je tepels zien', 5),
(3, 'Geef iemand een nek vol met zoenen', 5),
(3, 'Ga op iemands gezicht zitten (met kleding aan)', 5),
(3, 'Laat iemand je ondergoed uittrekken', 5),
(3, 'Zoen iemands buik', 5),
(3, 'Trek je onderbroek uit onder je kleding', 5),
(3, 'Laat iemand je borsten kussen', 5),
(3, 'Geef iemand een tongzoen terwijl je op hun schoot zit', 5),
(3, 'Laat iemand je dijbenen kussen', 5),
(3, 'Dans naakt voor 30 seconden (alleen ondergoed mag aan)', 5),
(3, 'Laat iemand je tepel aanraken', 5),
(3, 'Ga op je rug liggen en laat iemand je tongzoenen', 5),
(3, 'Laat iemand je kont zien', 5),
(3, 'Geef iemand een tongzoen van achteren', 5),
(3, 'Laat iemand aan je borsten likken', 5),
(3, 'Ga op handen en voeten zitten en laat iemand achter je komen', 5),
(3, 'Laat iemand je kruis kussen door je kleren heen', 5),
(3, 'Geef iemand een kus op hun geslachtsdeel (door kleding)', 5),
(3, 'Laat iemand je billen masseren', 5),
(3, 'Dans topless (meisjes: bh mag aan)', 5),
(3, 'Laat iemand je tepels zuigen door je shirt heen', 5),
(3, 'Ga schrijlings zitten en tonzzoen voor 30 seconden', 5),
(3, 'Laat iemand je slipje opzij schuiven', 5),
(3, 'Geef iemand een body shot (likken, drinken, bijten)', 5),
(3, 'Laat iemand je borsten vasthouden', 5),
(3, 'Ga op iemands schoot zitten en wrijf tegen hun kruis', 5),
(3, 'Laat iemand je billen uitkleden', 5),
(3, 'Geef iemand een zoen op hun innerlijke dijbeen', 5),
(3, 'Laat iemand je ondergoed opzij schuiven en kussen', 5),
(3, 'Dans met alleen ondergoed aan', 5),
(3, 'Laat iemand je nek bijten', 5),
(3, 'Ga op je knieën en laat iemand voor je staan', 5),
(3, 'Laat iemand je tepel in hun mond nemen', 5),
(3, 'Geef iemand een tongzoen terwijl je hun kruis aanraakt', 5),
(3, 'Laat iemand je ondergoed helemaal uittrekken', 5),
(3, 'Dans naakt (ondergoed uit)', 5),
(3, 'Laat iemand je borsten naakt zien', 5),
(3, 'Ga op je rug liggen en spreid je benen', 5),
(3, 'Laat iemand over je blote lichaam strelen', 5),
(3, 'Geef iemand een tongzoen terwijl je naakt bent', 5),
(3, 'Laat iemand je billen zien zonder ondergoed', 5),
(3, 'Ga op iemands gezicht zitten zonder ondergoed', 5),
(3, 'Laat iemand je kruis likken door je ondergoed', 5),
(3, 'Geef iemand orale seks door kleding heen', 5),
(3, 'Laat iemand je tepels likken', 5),
(3, 'Ga op handen en knieën en laat iemand je van achteren kussen', 5),
(3, 'Laat iemand je vingeren door je ondergoed', 5),
(3, 'Dans een hele minuut compleet naakt', 5),
(3, 'Laat iemand je borsten zuigen', 5),
(3, 'Ga op iemands schoot zitten en simuleer seks', 5),
(3, 'Laat iemand je kont kussen', 5),
(3, 'Geef iemand een tongzoen terwijl je hun geslachtsdeel aanraakt', 5),
(3, 'Laat iemand je geslachtsdeel aanraken', 5),
(3, 'Ga op je rug liggen en laat iemand over je lichaam likken', 5),
(3, 'Laat iemand je tepel bijten', 5),
(3, 'Dans terwijl iemand je borsten vasthoudt', 5),
(3, 'Laat iemand hun vinger in je mond stoppen en zuig erop', 5),
(3, 'Ga schrijlings op iemand zitten en tongzoen terwijl je beweegt', 5),
(3, 'Laat iemand je billen uit elkaar trekken', 5),
(3, 'Geef iemand een zoen op hun anus (door ondergoed)', 5),
(3, 'Laat iemand je kruis likken zonder ondergoed', 5),
(3, 'Ga op je knieën voor iemand en open je mond', 5),
(3, 'Laat iemand je tepels knijpen', 5),
(3, 'Dans terwijl iemand je kont vasthoudt', 5),
(3, 'Laat iemand je vingeren', 5),
(3, 'Ga op iemands gezicht zitten en beweeg', 5),
(3, 'Laat iemand aan je geslachtsdeel ruiken', 5),
(3, 'Geef iemand een tongzoen terwijl ze je vingeren', 5),
(3, 'Laat iemand je borsten masseren zonder kleding', 5),
(3, 'Ga op handen en knieën en laat iemand je kont kussen', 5),
(3, 'Laat iemand je geslachtsdeel kussen', 5),
(3, 'Dans terwijl iemand je tepels aanraakt', 5),
(3, 'Laat iemand een vinger in je steken', 5),
(3, 'Ga op je rug liggen met je benen omhoog', 5),
(3, 'Laat iemand je anus aanraken', 5),
(3, 'Geef iemand orale seks voor 30 seconden', 5),
(3, 'Laat iemand je geslachtsdeel masseren', 5),
(3, 'Ga schrijlings zitten en laat iemand je borsten zuigen', 5),
(3, 'Laat iemand je kont likken', 5),
(3, 'Dans terwijl iemand hun vinger in je heeft', 5),
(3, 'Laat iemand je tot een orgasme brengen', 5),
(3, 'Ga op iemands schoot zitten en laat je penetreren', 5),
(3, 'Laat iemand je volledig naakt uitkleden', 5),
(3, 'Geef iemand een volledige tongzoen terwijl je seks hebt', 5),
(3, 'Laat iemand je in verschillende posities nemen', 5);
SEED
